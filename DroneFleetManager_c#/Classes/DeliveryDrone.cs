...
namespace DroneFleetManager_c_.Classes
{
    ...
    {
        public double MaxPackageWeight { get; set; }    
        public DeliveryDrone (int id,string name,int battery,double speed , double maxPackageWeight,int x,int y)
        ...
        public override void AssignMission(string mission)
        {
            ...
            Status = "On Delivery Mission";
            Battery = Battery - 20;
        }
        public override void Draw(Graphics g)
        {
            Pen pen = new Pen(Color.Black, 2);
            Brush bodyBrush = Brushes.SaddleBrown;
            ...
            g.DrawString("D", new Font("Segoe UI", 8, FontStyle.Bold), Brushes.White, X + 27, Y + 18);
        }
        public override string GetInfo()
        {
            return $"Delivery Drone  | ID: {Id},Name: {Name},Battery: {Battery}%,Status: {Status},Mission: {CurrentMission},Max Weight: {MaxPackageWeight}kg";
        }
    }
}
